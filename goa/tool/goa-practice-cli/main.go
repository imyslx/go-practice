...
import (
	...
	"github.com/imyslx/go-practice/goa/client"
	"github.com/imyslx/go-practice/goa/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "goa Practice-cli",
		Short: `CLI client for the goa Practice service (https://github.com/imyslx/go-practice/goa/README.md)`,
	}
	...
	c.UserAgent = "goa Practice-cli/0"
